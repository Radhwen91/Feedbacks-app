...
function App() {
  const feedbacks: Feedback[] = [
    new Feedback('src/assets/ph4.jpg', 5, 'The coissants are perfectly flaky and buttery, providing a mouthwatery, providing a mouthwatering base for a variety of creative fillings.','w-1/2 flex flex-col items-start p-4 transform scale-110 -rotate-6','w-1/4'),
